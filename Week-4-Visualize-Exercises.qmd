...
A: This code will create a scatter plot with engine size on the x axis and mileage on the y axis. geom_smooth will add a smoothed trend line, and then the graph is saved as a jpg.
